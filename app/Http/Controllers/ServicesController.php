    ...
    public function index(Request $request)
{
    ...
    return view('admin.services.index', compact('service', 'id'));
}
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.services.create', compact('dropdownOptions','sdropdownOptions','ssdropdownOptions','id'));
    ...
    public function show(Services $service)
    {
        ...
        $sdropdownOptions = OurServices::all();
        $ssdropdownOptions = SubServices::all();
         return view('admin.services.show',compact('service','dropdownOptions','sdropdownOptions','ssdropdownOptions'));
    }
    ...
    public function edit(Services $service)
    {
        ...
        $sdropdownOptions = OurServices::all();
        $ssdropdownOptions = SubServices::all();
         return view('admin.services.edit',compact('service','dropdownOptions','sdropdownOptions','ssdropdownOptions'));
    }
