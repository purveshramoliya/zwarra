        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <div class="row">
                    ...
                    <!-- left column -->
                    <div class="col-md-12">
                        <h3 class="poppins-semibold zw_34 zw_text_AF2245 mt-4 mb-4">Show Doctor Position</h3>
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row zw_form_row">
                                    <div class="form-group  zw_18 poppins-medium  col-md-6">
                                        <label class="zw_text_AF2245 poppins-bold" for="exampleInputEndescription">En Medical Department :</label>
                                        {{ $doctorposition->Enmedicaldepartment }}
                                    </div>
                                    <div class="form-group  zw_18 poppins-medium  col-md-6">
                                        <label class="zw_text_AF2245 poppins-bold" for="exampleInputStatus">Ar Medical Department :</label>
                                        {{ $doctorposition->Armedicaldepartment }}
                                    </div>
                                </div>
                                <div class="form-row zw_form_row">
                                    <div class="form-group  zw_18 poppins-medium col-md-6">
