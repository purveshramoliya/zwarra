    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="poppins-semibold zw_34 zw_text_AF2245 mt-3">Edit Medical Department</h3>
                    </div>
                    <!-- left column -->
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            @endif
                            <!-- form start -->
                            <form action="{{ route('medicalspecialties.update',$medicalspecialty->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                          ...
                          <div class="form-row zw_form_row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="Enname" value="{{ $medicalspecialty->Enname }}" class="form-control poppins-regular zw_18 zw_text_898B9F zw_form_control" id="exampleInputEnhealthcare" placeholder="Enter En Healthcare">
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="Arname" value="{{ $medicalspecialty->Arname }}" class="form-control poppins-regular zw_18 zw_text_898B9F zw_form_control" id="exampleInputArhealthcare" placeholder="Enter Ar Healthcare">
                            </div>
                        </div>
                        <div class="form-row zw_form_row">
                            <div class="form-group col-md-6">
                                <label class="zw_label_height zw_poppins_regular poppins-regular zw_20 zw_text_111535" for="exampleInputEstimatedtime">En description <span style="color: red;">*</span></label>
