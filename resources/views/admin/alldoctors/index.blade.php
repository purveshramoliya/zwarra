    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="row">
          ...
          <div class="col-12 col-md-12 col-lg-6">
            <a class="btn zw_add_btn float-right  poppins-medium zw_18" href="{{ route('alldoctors.create') }}"> <i class="fas fa-plus right mr-2"></i>Add Doctor</a>
          </div>
        </div>
        <div class="row">
          <div class="col-12">
