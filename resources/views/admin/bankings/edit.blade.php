  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <div class="row">
          <div class="col-sm-12">
            <h3 class="poppins-semibold zw_34 zw_text_AF2245 mt-3">Edit Banking Information</h3>
          </div>
          <!-- left column -->
          <div class="col-md-12">
                                ...
                                <div class="card-body">
                                 <div class="form-row zw_form_row">
                                  <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="Name"  value="{{ $banking->Name }}" class="form-control poppins-regular zw_18 zw_text_898B9F zw_form_control" id="exampleInputName" placeholder="Enter Name">
                                  </div>
                                  <div class="form-group col-md-6">
                                    ...
                                    <input type="phone" name="Phone"  value="{{ $banking->Phone }}" class="form-control poppins-regular zw_18 zw_text_898B9F zw_form_control" id="exampleInputPhone" placeholder="Enter Phone Number">
                                  </div>
                                </div>
                                <div class="form-row zw_form_row">
                                  <div class="form-group col-md-6">
                                    ...
                                    <input type="email" name="Email"  value="{{ $banking->Email }}" class="form-control poppins-regular zw_18 zw_text_898B9F zw_form_control" id="exampleInputEmail" placeholder="Enter Email">
                                  </div>
                                  <div class="form-group col-md-6">
                                    ...
                                    @if($option->Enname != $banking->Doctor) <!-- Assuming $selectedValue contains the currently selected ID -->
