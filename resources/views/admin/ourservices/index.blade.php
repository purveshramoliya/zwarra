                ...
                <table class="table table-hover text-nowrap zw_table">
                  <thead class="zw_bg_AF2245 zw_text_ffffff">
                    <tr>
                      ...
                      <th class="poppins-medium zw_18">Type of services</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="poppins-regular zw_14 zw_text_333333"><img class="center-block" width="50px" height="" src="{{ asset($ourservices->Logo) }}" height="" width="50px" /></td>

                      <td class="poppins-regular zw_14 zw_text_333333">{{ $ourservices->Enname }}</td>
                      <td class="poppins-regular zw_14 zw_text_333333">{{ $ourservices->Arname }}</td>
                      <td class="poppins-regular zw_14 zw_text_333333">{{ $ourservices->Testcategory }}</td>
                      ...
                      <td class="poppins-regular zw_14 zw_text_333333">
                        <form action="{{ route('ourservices.destroy',$ourservices->id) }}" method="POST">
                          <!-- <a class="btn zw_btn" href="{{ route('ourservices.show',$ourservices->id) }}">Show</a> -->
                          @csrf
                          @method('DELETE')
