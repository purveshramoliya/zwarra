  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <div class="row">
          <div class="col-sm-12">
              <h3 class="poppins-semibold zw_34 zw_text_AF2245 mt-3">Edit Contact</h3>
          </div>
          <!-- left column -->
          <div class="col-md-12">
                ...
                <div class="card-body">
                  <div class="form-row zw_form_row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="Subject" value="{{ $contact->Subject }}" class="form-control poppins-regular zw_18 zw_text_898B9F zw_form_control" id="exampleInputSubject" placeholder="Enter Subject">
                    </div>
                    <div class="form-group col-md-6">
                      ...
                      <input type="phone" name="Phone" value="{{ $contact->Phone }}" class="form-control poppins-regular zw_18 zw_text_898B9F zw_form_control" id="exampleInputPhone" placeholder="Enter Phone">
                    </div>
                  </div>
                  <div class="form-row zw_form_row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="email" name="Email" value="{{ $contact->Email }}" class="form-control poppins-regular zw_18 zw_text_898B9F zw_form_control" id="exampleInputEmail" placeholder="Enter Email">
                    </div>
                    <div class="form-group col-md-6">
                      ...
                      <textarea name="Message" rows="1" class="form-control poppins-regular zw_18 zw_text_898B9F zw_form_control" id="exampleInputMessage" placeholder="Enter Message">{{ $contact->Message }}</textarea>
                    </div>
                  </div>
                  <div class="form-row zw_form_row">
                    <div class="form-group col-md-6">
                      ...
                      <select name="Doctor" class="custom-select poppins-regular zw_18 zw_text_898B9F zw_form_control zw_box_shadow_none">
                        <option value="{{ $contact->Doctor }}" selected="selected">{{ $contact->Doctor }}</option>
