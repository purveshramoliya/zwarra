@include('admin.layouts.headermodule') <body class="hold-transition sidebar-mini zw_sidebar">
				  ...
				  <tbody>
					<tr>
					  <td class="poppins-regular zw_14 zw_text_333333 text-center">
						<img class="center-block" width="50px" height="" src="http://127.0.0.1:8000/uploads/تنزيل (6).png">
					  </td>
					  <td class="poppins-regular zw_14 zw_text_333333">Video consultation</td>
					  <td class="poppins-regular zw_14 zw_text_333333">رحمت</td>
					  <td class="poppins-regular zw_14 zw_text_333333">
						<label class="switch">
						  <form id="statusForm" class="statusForm">
							<input type="hidden" name="ssid" id="ssid" class="ssid" value="">
					...
					<tr>
					  ...
					  <td class="poppins-regular zw_14 zw_text_333333">Laboratory</td>
					  <td class="poppins-regular zw_14 zw_text_333333">رحمت</td>
					  <td class="poppins-regular zw_14 zw_text_333333">
						<label class="switch">
						  <form id="statusForm" class="statusForm">
					...
					<tr>
					  ...
					  <td class="poppins-regular zw_14 zw_text_333333">Home visit Doctor</td>
					  <td class="poppins-regular zw_14 zw_text_333333">رحمت</td>
					  <td class="poppins-regular zw_14 zw_text_333333">
						<label class="switch">
						  <form id="statusForm" class="statusForm">
					...
					<tr>
					  ...
					  <td class="poppins-regular zw_14 zw_text_333333">Vitamin IV Drips</td>
					  <td class="poppins-regular zw_14 zw_text_333333">رحمت</td>
					  <td class="poppins-regular zw_14 zw_text_333333">
						<label class="switch">
						  <form id="statusForm" class="statusForm">
	...
	</div> @include('admin.layouts.footer') </div>
	<script>
