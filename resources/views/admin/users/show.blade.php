        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="row ">
                    ...
                    <div class="col-sm-6 ">
                        <a class="btn zw_btn float-right m-2" href="{{ route('users.edit',$user->id) }}">Update</a>
                    </div>
                </div>
                <div class="row">
                    <!-- <a class="btn zw_btn m-2" href="{{ route('users.index') }}"> Back</a> -->
                    <!-- <a class="btn zw_btn float-right m-2" href="{{ route('users.edit',$user->id) }}">Update</a> -->
                    <!-- left column -->
                    <div class="col-md-12">

                        <h3 class="poppins-semibold zw_34 zw_text_AF2245 mt-4 mb-4">Users</h3>
