  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <div class="row">
          <div class="col-sm-12">
              <h3 class="poppins-semibold zw_34 zw_text_AF2245 mt-3">Edit Banner</h3>
          </div>
          <!-- left column -->
          <div class="col-md-12">
                  ...
                  <div class="form-row zw_form_row">
                    <div class="form-group col-md-6">
                     <label for="exampleInputtitle" class="zw_label_height zw_label_height zw_poppins_regular poppins-regular zw_20 zw_text_111535">Title</label>
                      <input type="text" name="title" class="form-control poppins-regular zw_18 zw_text_898B9F zw_form_control" id="exampleInputCode" placeholder="Enter title" value="{{ $image->title }}">
                    </div>
                    <div class="form-group col-md-6">
                      <label class="zw_label_height zw_poppins_regular poppins-regular zw_20 zw_text_111535" for="exampleInputCode">Description <span style="color: red;">*</span></label>
                       <textarea name="description" class="form-control poppins-regular zw_18 zw_text_898B9F zw_form_control" id="exampleInputIssues" rows="1" placeholder="Enter Description">{{ $image->description }}</textarea>
                    </div>
                  </div>
                  <div class="form-row zw_form_row">
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="url" name="redirect_url" class="form-control poppins-regular zw_18 zw_text_898B9F zw_form_control" id="exampleInputCode" placeholder="Enter Redirect Url" value="{{ $image->redirect_url }}">
                    </div>
                  </div>
