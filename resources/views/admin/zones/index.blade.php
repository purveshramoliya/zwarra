...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- Include a section for JavaScript -->
        @section('scripts')
        <script>
                    ...
                    <table class="table table-hover text-nowrap zw_table">
                        ...
                        <tbody>
                            ...
                            <td class="poppins-regular zw_14 zw_text_333333">
                                {{ $zone->country ? $zone->country->Enname : '' }}
                            </td>
                            <td class="poppins-regular zw_14 zw_text_333333">
                                {{ $zone->city ? $zone->city->Arcityname : '' }}
                            </td>
                            <td class="poppins-regular zw_14 zw_text_333333">
                                {{ $zone->Enname ? $zone->Enname : '' }}
                            </td>
                            <td class="poppins-regular zw_14 zw_text_333333">
...
$.ajax({
    ...
    success: function(data) {
        ...
        $.each(data, function(index, zone) {
            zonesDropdown.append('<option value="' + zone.Enname + '">' + zone.Enname + '</option>');
        });
    },
    error: function(error) {
