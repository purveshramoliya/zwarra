                    ...
                    <div class="card zw_login_card zw_login_mtb zw_bg_f6f6f6">
                        ...
                        <div class="card-body p-2">
                             ...
                             <div class="form-group mb-4 zw_bg_ffffff zw_login_form_control zw_bor_radi_6" style="padding: 3px 10px;">
                                <button type="button" id="emailTab" class="btn zw_bg_f7e9ec p-2 zw_bor_radi_6" style="width: 95px;">Email</button>
                                <button type="button" id="smsTab" class="btn p-2 float-right zw_bor_radi_6" style="width: 95px;">Phone</button>
                            </div>

                            <form method="POST" action="{{ route('password.email') }}" id="emailField">
                                @csrf
                             ...
                             <form method="POST" action="{{ route('password.phone') }}" id="smsField" style="display: none;">
                                @csrf
