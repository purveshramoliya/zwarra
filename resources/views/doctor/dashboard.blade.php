...
<html>
<head>
  <title>Zwarra Doctor Panel</title>
                    ...
                    <div class="row my-4">
                      ...
                      <div class="col-12 d-md-flex ">
                       ...
                       <div class="mx-3 zw_service_btn w-100 ">
                        <a class="btn text-start" href="{{ route('doctor.dashboard') }}">All Requests</a>
                        <a class="btn text-start" href="{{ route('doctordashboard.status', ['status' => 'Pending']) }}">Pending</a>
                        <a class="btn text-start" href="{{ route('doctordashboard.status', ['status' => 'Approved']) }}">Approved</a>
                        <a class="btn text-start" href="{{ route('doctordashboard.status', ['status' => 'Rejected']) }}">Rejected</a>
                        <a class="btn text-start" href="{{ route('doctordashboard.status', ['status' => 'Completed']) }}">Completed</a>
                        <a class="btn text-start" href="{{ route('doctordashboard.status', ['status' => 'InCompleted']) }}">InCompleted</a>
                        <a class="btn text-start" href="{{ route('doctordashboard.status', ['status' => 'Refund']) }}">Refunded</a>
                      </div>
