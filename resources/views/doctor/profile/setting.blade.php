                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class=" card-primary">
                      ...
                      @endif
                      <!-- form start -->
                      <form action="{{ route('doctor.config.store') }}" method="POST">
                        @csrf
                        <input type="hidden" name="id" value="{{ Auth::guard('doctor')->id() }}">
    ...
    <div class="hiddenbacc" id="updatebankaccd">    
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class=" card-primary">
            <!-- form start -->
            <form action="{{ route('doctor.banking.store') }}" method="POST">
              @csrf
              <input type="hidden" name="Healthcare" value="{{ Auth::guard('doctor')->id() }}">
              <!-- /.card-header -->
              @if ($errors->any())
              <div class="alert zw_alert_danger">
                There were some problems with your input.<br><br>
