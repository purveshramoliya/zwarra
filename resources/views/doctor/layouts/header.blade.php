    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                <a href="{{ route('doctor.profile.show') }}" class="dropdown-item zw_a_n zw_text_000000">
                    Your Profile 

                </a>
                <div class="dropdown-divider"></div>
                <a href="{{ route('doctor.profile.setting')}}" class="dropdown-item zw_a_n zw_text_000000">
                    Settings
                </a>
            </div>
        </li>
