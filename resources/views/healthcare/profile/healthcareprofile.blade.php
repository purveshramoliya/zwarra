                    ...
                    <div class="col-md-12  text-white py-2">
                        <div class="card healthcareprofile-card">
                            ...
                            <div class="card-body px-4 py-2 ">
                                ...
                                <P class="mt-3 text-secondary"><i class="fa-solid fa-location-dot"></i> <span class="mx-2 zw_text_707070"> {{ $serviceprovider->City ?: ''}}</span></P>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class=" px-4 py-2  text-center ">
                                    ...
                                    <P class="mt-3 text-secondary"> {{ $serviceprovider->email }}</P>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class=" px-4 py-2 text-primary text-center ">
                                    <h6 class="text-body ">Phone number</h6>
                                    <P class="mt-3 text-secondary"> {{ $serviceprovider->Phone }}</P>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class=" px-4 py-2 text-primary text-center ">
                                    <h6 class="text-body ">VAT number</h6>
                                    <P class="mt-3 text-secondary"> {{ $serviceprovider->Vat }}</P>
                                </div>
                            </div>
                        </div>
                    </div>
