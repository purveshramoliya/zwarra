            ...
            <div class="card-body">
              <div class="form-row zw_form_row">
                ...
                <div class="form-group col-md-6">
                  <form id="country-form" method="POST" action="{{ route('locations.hstoreCountry') }}">
                    @csrf
                    ...
                    <div class="col-md-12">
                      ...
                      <button type="submit" class="btn zw_add_btn poppins-medium zw_18 float-right">Add Country</button>
                    </div>
                  </form>
                </div>
                ...
                <!-- Add City Form -->
                <div class="form-group col-md-6">
                  <form id="city-form" method="POST" action="{{ route('locations.hstoreCity') }}">
                    @csrf
                    <div class="row">
                      <div class="col-md-6">
              ...
              <div class="form-row zw_form_row">
                ...
                <div class="form-group col-md-12">
                  <form id="zone-form" method="POST" action="{{ route('locations.hstoreZone') }}">
                    @csrf
                    <div class="row">
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#country-form').on('submit', function(e) {
        ...
        $.ajax({
          url: '{{ route('locations.hstoreCountry') }}',
          type: 'POST',
          data: $(this).serialize(),
      ...
      $('#city-form').on('submit', function(e) {
        ...
        $.ajax({
          url: '{{ route('locations.hstoreCity') }}',
          type: 'POST',
          data: $(this).serialize(),
          success: function(response) {
            $('#city_name').val('');
      ...
      $('#zone-form').on('submit', function(e) {
        ...
        $.ajax({
          url: '{{ route('locations.hstoreZone') }}',
          type: 'POST',
          data: $(this).serialize(),
          success: function(response) {
            $('#zone_name').val('');
    ...
    $('#zone_country_id').on('change', function() {
      ...
      if (countryId) {
        $.ajax({
          url: '{{ route('locations.hgetCities') }}',
          type: 'POST',
          data: {
