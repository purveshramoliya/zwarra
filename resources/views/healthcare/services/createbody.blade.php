              ...
              <form action="{{ route('healthcare.services.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-row zw_form_row">
                    ...
                    <div class="form-group col-md-6">
                      <label class="zw_label_height zw_poppins_regular poppins-regular zw_20 zw_text_111535" for="exampleInputSubservicename">Sub Service Name <span style="color: red;">*</span></label>
